...
const EVENT_TO_QUERY_KEYS: Record<string, string[][]> = {
  ...
  "settings:updated": [["/api/settings/site-name"], ["/api/settings/key-prefix"], ["/api/settings/features"], ["/api/settings/modname"], ["/api/settings/ftext"], ["/api/settings/maintenance"], ["/api/settings/session"]],
