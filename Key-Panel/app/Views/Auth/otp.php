...
<div class="otp-card">
  ...
  <p>We sent a 6-digit verification code to your Telegram account.</p>
  ...
  <div class="otp-help">
    Code expires in 5 minutes. Didn't receive it? Ensure your Telegram Chat ID is correctly set in Settings and you've started the bot.
  </div>
</div>
<?= $this->endSection() ?>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (otpInput) {
    ...
    // Clear input on wrong OTP to let user type again
    <?php if (session()->getFlashdata('error')): ?>
      otpInput.value = '';
      otpInput.focus();
    <?php endif; ?>
...
// Auto-tab between OTP digits (if you want to implement 6 separate inputs)
// This is optional - keeping single input for simplicity
